    ...
    public ResponseEntity<Object> createUser(@RequestBody User user) {
        try {
            ...
            User _user = userRepository.save(
                    new User(user.getName(), user.getEmail(), encodedPass, user.getPhone(), UserRole.BUYER));

            _user.setPassword(null);

            // Send email
//            String subject = "Welcome to BitsBID";
//            String body = "Hello " + _user.getName() + ",\n\n"
//                    + "You can now start ordering your favoutite stuff directly from our website.\n\n"
